...
+ function($) {
  ...
  $.login = function(text, title, onOK, onCancel, username, password) {
    ...
    $.activelogin = function(text, title, onOK, onCancel, username, password) {
        var config;
        if (typeof text === 'object') {
            config = text;
        } else {
        ...
        var modal = $.modal({
            text: '<p class="weui-prompt-text">'+(config.text || '')+'</p>' +
            '<input type="tel" class="weui-input weui-prompt-input" id="weui-prompt-username" value="' + (config.username || '') + '" placeholder="手机号" />' +
            '<input type="text" class="weui-input weui-prompt-input" id="weui-prompt-password" value="' + (config.password || '') + '" placeholder="激活码" />',
            title: config.title,
            autoClose: false,
            buttons: [
                {
